...
public class User implements Player {
   ...
   */
  public User(Model m, String name, List<Coord> v) {
    model = m;
    username = name;
    volley = v;
  }
  ...
  public List<Coord> reportDamage(List<Coord> opponentShotsOnBoard) {
    ...
    for (Coord[] compRow : model.getUserBoard().getBoard()) {
    ...
    model.updateUserBoard(hitList, missList);
    return hitList;
  }
  ...
  public void successfulHits(List<Coord> shotsThatHitOpponentShips) {
    ...
    List<Coord> misses = volley;
        model.showUserShots(shotsThatHitOpponentShips, misses);
  }
  ...
  public void endGame(GameResult result, String reason) {
    model.setUserEndMessage(result, reason);
  }
}
